...
<script src="{{asset('js/marcasAdmin.js')}}"></script>
    ...
    <div class="jumbotron jumbotron-fluid my-auto bg-white w-100">
        <div class="container">
            ...
            <div id="agregarMarca">
                ...
                @endforeach
                <form class="w-100" id="formularioAgregar" method="POST" action="/marca/add"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" class="form-control" id="nombre" name="nombre"
                            placeholder="Nombre del la Marca" value="{{old('nombre')}}" required>
                    </div>
                    <div class="form-group">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn botonActualizar" id="{{$marca->id}}">
                            ...
                            <td>
                                <form action="/marca/delete/" method="post" id="formDelete{{$marca->id}}">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="_method" value="DELETE">
                                    <input type="hidden" name="idDelete" value="{{$marca->id}}">
                        ...
                        <tr class="d-none" id="#editar{{$marca->id}}">
                            <td colspan="10">
                                <form class="w-100" id="formularioEditar" method="POST" action="/marca/edit"
                                    enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nombreEditar" name="nombreEditar"
                                            placeholder="Nombre de la Marca" value="{{$marca->nombre}}" required>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary">
                                            Actualizar
